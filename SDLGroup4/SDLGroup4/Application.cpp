...
namespace Engine {
	bool Application::Initialize()
	{
		...
		//entity = new Entity("Assets/Sprites/enemy_drone_larger_red.png", 100, 100, 501, 195, "1");
		entity = new Entity("Assets/Sprites/enemy_drone_larger_red.png", 100, 100, 504, 150, "1");
		entity2 = new Entity("Assets/Sprites/enemy_drone_larger_red.png", 100, 100, 600, 100, "2");
		return true;
	}
